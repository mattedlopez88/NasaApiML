...
namespace NasaApiML.ViewModels;

public class ApodViewModelsML : INotifyPropertyChanged
{
    ...
    private ApodServiceML service;
    public ApodServiceML Service
    {
        get
        {
            if (service == null)
            {
                service = new ApodServiceML();
            }
            return service;
        }
    }
    ...
    {
        matiasL dto = await Service.GetImage(day);
        if (dto == null)
        {
